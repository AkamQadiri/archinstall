...
export X_PACKAGES="dunst gnome-keyring i3blocks i3-wm libnotify lxsession-gtk3 numlockx perl-file-mimeinfo picom rofi rofi-calc rofi-emoji rtkit unclutter xdg-desktop-portal xdg-desktop-portal-gtk xdg-utils xdotool xorg xorg-apps xorg-xinit"
...
# Essential utilities
export ADDITIONAL_PACKAGES="chafa fd feh firefox flameshot fzf ghostty git git-lfs htop jq mpv neovim npm playerctl ripgrep rsync unzip zip"
