...
#Packages
export X_PACKAGES="xorg xorg-xinit xorg-apps xdg-utils perl-file-mimeinfo xdotool picom lxsession-gtk3 unclutter"
...
export AUDIO_PACKAGES="pipewire pipewire-alsa pipewire-pulse pipewire-jack noise-suppression-for-voice"
